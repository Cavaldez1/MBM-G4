...
Programas de vigilancia costera utilizan análisis moleculares para detectar proliferación de Vibrio relacionada con:
...
NCBI y otras bases internacionales almacenan secuencias bacterianas utilizadas en monitoreo global de patógenos.
